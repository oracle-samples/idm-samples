  ...
  <div class="center wrap cls">
    ...
    <!-- CONTENT: BEGIN -->
      <header>
        ...
        <p><strong>Warning!</strong> <%=request.getParameter("errorMsg") %>. <a href="/cquotes/index.jsp" class="alert-link">return to home.</a></p>
        <p><a class="bt bt-navy" href="/cquotes/index.jsp"><i class="fa fa-undo" aria-hidden="true"></i> | Go back Home</a></p>
      </header>
      <hr>
    </article>
  </div> <!-- #main -->
