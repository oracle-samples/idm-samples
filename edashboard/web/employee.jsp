...
<div class="main-area">
  <div class="center wrap cls">
    ...
    <!-- CONTENT: BEGIN -->
      ...
      <section>
        <hr>
        <h2><i class="fa fa-thumbs-up" aria-hidden="true"></i> Employee perks</h2>
        <ul>
            <li><i class="fa fa-money" aria-hidden="true"></i> Company matching 401k</li>
            <li><i class="fa fa-medkit" aria-hidden="true"></i> Premium Healthcare insurance</li>
            <li><i class="fa fa-cutlery" aria-hidden="true"></i> Free meals</li>
            <li><i class="fa fa-plane" aria-hidden="true"></i> Vacation discounts</li>
            <li><i class="fa fa-beer" aria-hidden="true"></i> Beer Fridays</li>
            <li><i class="fa fa-ticket" aria-hidden="true"></i> Free events every month</li>
        </ul>
        <hr>
