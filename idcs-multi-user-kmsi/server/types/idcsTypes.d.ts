...
//Users obviously have lots of fields, so this can be fleshed out as required
interface User {
  id: string;
  active?: boolean;
  "urn:ietf:params:scim:schemas:oracle:idcs:extension:passwordState:User"?: UserPasswordState
}

interface UserPasswordState {
  applicablePasswordPolicy?: UserPasswordPolicy
}
